    ...
    <section className="bg-indigo-600 text-white py-16 px-4">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-indigo-100 leading-relaxed mb-8">
          Contact us to place an order, ask a question, or simply learn more
          about our premium selections. We&apos;re here to help you get the best
          cuts for your next meal.
        </p>
      </div>
      <div className="mt-8 flex flex-col md:flex-row items-start justify-center md:items-center space-y-6 md:space-y-0 md:space-x-12">
        {/* Phone */}
        ...
        <div className="flex items-center space-x-3">
          ...
          <a
            href="mailto:sushilghimire@gmail.com"
            className="text-lg font-medium text-white transition-colors duration-300"
          >
            sushilghimire@gmail.com
          </a>
        </div>
